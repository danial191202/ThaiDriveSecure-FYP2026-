          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
            _serviceCard(
              iconPath: 'assets/adapter.png',
              name: 'Adapter',
              price: 'RM 9.00',
              description:
                  'Travel worry-free with a universal power adapter for your devices.',
            ),
            ...
            Center(
              child: Row(
                ...
                children: [
                  _sampleImage('assets/adapter1.png'),
                  const SizedBox(width: 8),
                  _sampleImage('assets/adapter2.jpg'),
                ],
              ),
            ),
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              onPressed: () {
                ...
                final double totalPrice = quantity * 9.0;
                Navigator.push(
                  context,
                  MaterialPageRoute(
