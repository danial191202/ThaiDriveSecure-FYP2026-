...
class VoluIns extends StatefulWidget {
  final String vehicleType;

  const VoluIns({super.key, required this.vehicleType});

  @override
  State<VoluIns> createState() => _VoluInsState();
}

class _VoluInsState extends State<VoluIns> {
